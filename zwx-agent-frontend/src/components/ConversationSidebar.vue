...
<style scoped>
.conversation-sidebar { width: 252px; flex: 0 0 252px; display: flex; flex-direction: column; min-height: 100vh; padding: 14px 10px; border-right: 1px solid #eaeaea; background: #f8f8f8; }
.sidebar-top { display: flex; align-items: center; justify-content: space-between; padding: 6px 8px 17px; }.brand { display: flex; align-items: center; gap: 9px; color: #1f1f1f; font-size: 16px; font-weight: 650; }.brand-mark { display: grid; width: 27px; height: 27px; place-items: center; border-radius: 8px; background: #fceff2; color: #d65070; font-size: 10px; font-weight: 700; }
